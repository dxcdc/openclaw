...
from .views import (root_page_view, openclaw_hub_view, openclaw_chat_view, docs_view, dynamic_pages_view)
...
urlpatterns = [
    ...
    path("openclaw/chat/", openclaw_chat_view, name="openclaw_chat"),
